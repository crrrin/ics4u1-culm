  ...
  public boolean run() {
    ...
    switch (choice) {
      ...
      case 3:
        ...
        Input.lore("You can now only use your fists in battle.");
...
class Event10 extends Event {
  ...
  public boolean run() {
    ...
    switch (choice) {
      ...
      case 2:
        Input.lore("You visit the tavern and order a few beers. You get drunk and pass out.");
        Input.lore("You can now only use your fists in battle.");
