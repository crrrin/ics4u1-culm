...
class Sword implements Weapon {
  ...
  public int use() {
    ...
    if (crit) {
      return Math.round(this.DAMAGE + this.DAMAGE * CRIT_DAMAGE_BONUS);
    } else {
      return this.DAMAGE;
    }
